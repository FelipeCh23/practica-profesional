...
from blast_cuts import apply_series_abanico  # Geometrías; Apply series
from blast_cuts import (
    apply_series_bethune,
    apply_series_coromant,
    apply_series_cuatro_secciones,
    apply_series_cuna,
    apply_series_sarrois,
    apply_series_sueco,
    cuele_abanico_geom,
    cuele_bethune_geom,
    cuele_coromant_geom,
    cuele_cuatro_secciones_geom,
    cuele_cuna_geom,
    cuele_sarrois_geom,
    cuele_sueco_geom,
)
...
holes = cuele_bethune_geom(
    d=d_b, dx_factor=1.2, y_levels=y_levels, invert_y=True, vy_factor=3.5
)
